...
async function uploadFile() {
    ...
    const response = await fetch(`/files/upload?path=${encodeURIComponent(path)}`, {
        method: "POST",
        body: formData
    });
    if (!response.ok) {
